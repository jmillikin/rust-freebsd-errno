...
/// Type for error numbers returned from FreeBSD system calls.
///
...
errno_constants! {
	// https://cgit.freebsd.org/src/tree/sys/sys/errno.h?h=release/13.1.0
...
pub const ENOTSUP: crate::Error = EOPNOTSUPP;
